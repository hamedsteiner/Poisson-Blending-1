...
disp('Choose target location');
disp('Click in the image to preview'); 
disp('Press "W""S" to resize and "A""D" to rotate'); 
disp('Press "Q" to finish.'); 
...
while 1
    ...
    fig = figure(2); hold off, imagesc(temp), axis image;
